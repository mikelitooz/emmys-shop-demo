  ...
  return (
    <main>
      <PageHero
        ...
        title="A friendly family-run flooring business in Middlesbrough with over 30 years experience."
        body="This demo positions Right Price Carpets as a trusted local flooring specialist in Middlesbrough, with an elevated digital experience that feels ready for modern retail."
